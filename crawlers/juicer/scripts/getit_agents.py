...
class CreateCSV(Utils):
	...
	def write_data_to_file(self, source):
		try:
			...
			query = 'select agency_name, city, phone_number, address, reference_url from getit_agents where created_at > DATE_ADD(NOW(), INTERVAL -1 DAY)'
